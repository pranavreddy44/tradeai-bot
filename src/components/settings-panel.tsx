...
const modelCards: {
...
}[] = [
  {
    id: 'auto',
    name: 'OmniRoute Auto',
    description: 'Default smart routing — OmniRoute picks the best provider/model with auto-fallback. Best for signal parsing and trading reasoning.',
    speed: 2,
    quality: 3,
    capability: 'Smart Routing',
    tag: 'DEFAULT',
  },
  {
    id: 'auto/coding',
    name: 'Coding Combo',
    description: 'Priority + fill-first routing optimized for structural parsing and code-like trade-level extraction.',
    speed: 2,
    quality: 3,
    capability: 'Structured Parsing',
    tag: 'BALANCED',
  },
  {
    id: 'auto/cheap',
    name: 'Cheap Combo',
    description: 'Cost-optimized routing — drains free tiers first for frequent scans and quick chat responses.',
    speed: 3,
    quality: 2,
